...
return [
    'settings' => [
        ...
        'utc_timezone' => true, //true=> Using default UTC timezones in all the DateTime responses, false=> Using the device_timezone as saved by user in the database (if available)
